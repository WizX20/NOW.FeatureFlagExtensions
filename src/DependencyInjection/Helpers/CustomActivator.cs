...
namespace NOW.FeatureFlagExtensions.DependencyInjection.Helpers
{
    ...
    {
        public static TObject CreateInstanceAndPopulateProperties<TObject>(Dictionary<string, object> propertiesValues, object[] instances = null)
            where TObject : class
        {
            ...
            if (desiredType.IsInterface)
            {
                ...
                return CreateInterfaceInstance<TObject>(propertiesValues, instances);
            }
            else
            {
        ...
        public static TObject CreateInstance<TObject>(object[] instances = null)
            where TObject : class
        {
            return CreateInstanceAndPopulateProperties<TObject>(null, instances);
        }
        ...
        private static TInterface CreateInterfaceInstance<TInterface>(Dictionary<string, object> propertiesValues = null, object[] instances = null)
            where TInterface : class
        {
            ...
            // custom
            expandoObject.Instances = instances;
